...
function adv_disp_rxn_pulse(params::PyDict)
    v = params["v"]
    ...
    eqA = Dt(CA(t, z)) ~ DaxialA * Dzz(CA(t, z)) - v * Dz(CA(t, z)) - k * CA(t, z) * CB(t, z)
    eqB = Dt(CB(t, z)) ~ DaxialB * Dzz(CB(t, z)) - v * Dz(CB(t, z)) - k * CA(t, z) * CB(t, z)
    eqC = Dt(CC(t, z)) ~ DaxialC * Dzz(CC(t, z)) - v * Dz(CC(t, z)) + k * CA(t, z) * CB(t, z)
...
function adv_disp_rxn_wave(params::PyDict)
    v = params["v"]
    DaxialA = params["DaxialA"]
    DaxialB = params["DaxialB"]
    DaxialC = params["DaxialC"]
...
function adv_disp_rxn_all(params::PyDict)
    v = params["v"]
    DaxialA = params["DaxialA"]
    DaxialB = params["DaxialB"]
    DaxialC = params["DaxialC"]
